...
<h3 align="center">
Engineering Science Graduate | Embedded Systems | Controls | Robotics | Automation
</h3>

<p align="center">
  <a href="https://www.linkedin.com/in/dorsadafchahi">
    <img
      src="https://img.shields.io/badge/LinkedIn-Dorsa%20Ahmadi%20Dafchahi-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"
      alt="LinkedIn"
    />
  </a>
...
- Worked with CAN communication, control interfaces, P&IDs, and system-level validation.
...
- Worked within a collaborative Git and GitHub development workflow.
- Participated in code reviews, debugging, testing, and technical documentation.
...
### 🦾 SCARA Robot Modeling & Kinematics

Modelled and analyzed a four-degree-of-freedom SCARA RRPR robotic manipulator.

- Defined the robot using Denavit-Hartenberg coordinate frames.
...
### 📈 SCARA Joint-Space Trajectory Planner

Developed a multi-segment trajectory-planning system for a SCARA robot.
...
- Classified water conditions based on measured pollution levels.
- Displayed real-time status information through an LCD interface.

**Technologies:** C, BeagleBone Green, sensors, embedded systems, LCD interfacing
